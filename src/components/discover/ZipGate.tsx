      ...
      <div className="relative w-full px-4 sm:px-6 py-10 sm:py-16 flex flex-col items-center justify-center min-h-[calc(100vh-4rem)]">
        ...
        >
          ...
          <Input
            ...
            onChange={(e) => setZip(e.target.value.replace(/\D/g, "").slice(0, 5))}
            autoFocus
            className="h-14 text-center text-2xl tracking-[0.4em] font-bold bg-white/5 border-2 border-transparent hover:border-white text-white placeholder:text-white/30 focus-visible:ring-0 focus-visible:border-white rounded-xl transition-colors"
          />
          {error && (
