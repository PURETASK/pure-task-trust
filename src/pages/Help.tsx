  ...
  return (
    <main className="flex-1">
      ...
      <FAQSchema faqs={[
        ...
        { question: "How do credit holds work?", answer: "When you book, we place a hold on your credits (not a charge). After the job, you can review and approve the final amount based on actual time worked — or credits are released automatically after 24 hours if no issue is reported." },
