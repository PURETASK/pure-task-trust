      ...
      <div className="space-y-6 max-w-3xl">
          ...
          <div className="relative overflow-hidden rounded-3xl border-2 border-primary/40 p-8">
            ...
            <div className="flex items-center gap-4 relative">
              ...
              <div>
                ...
                <p className="text-ink-muted mt-1">Control when you work and manage your schedule</p>
              </div>
            </div>
          </div>
        </motion.div>
        ...
        <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.15 }}>
          <Tabs defaultValue="weekly" className="space-y-5">
            <TabsList className="rounded-2xl h-12 p-1 border-2 border-hairline-soft bg-muted/40 w-full">
