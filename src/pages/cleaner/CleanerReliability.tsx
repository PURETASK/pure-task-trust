...
import { TrendingUp, Info, ExternalLink, AlertTriangle, CheckCircle2, Clock, Star, Award } from "lucide-react";
...
export default function CleanerReliability() {
  ...
  // Correct tier boundaries: Bronze 0–49, Silver 50–69, Gold 70–89, Platinum 90–100
  const nextTierPoints = tier === "bronze" ? 50 - score :
                         tier === "silver" ? 70 - score :
                         tier === "gold"   ? 90 - score : 0;
                  ...
                  return (
                    ...
                    >
                      ...
                      <div className="flex items-center gap-2">
                        <Badge
                          variant={!meta.positive ? "destructive" : "default"}
                          className={meta.positive ? "bg-success/10 text-success border-success/30" : ""}
                        >
